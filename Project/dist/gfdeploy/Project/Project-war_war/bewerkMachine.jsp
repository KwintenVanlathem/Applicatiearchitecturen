    ...
    <body>
        ...
        <form method="post" action="">
            <table>
                ...
                <tr>
                    <td>${sessionScope.machine.serienummer}</td>
                    <td><input type="text" value="${sessionScope.machine.naam}" name="naam"></td>
                    <td><input type="text" value="${sessionScope.machine.lokaal}" name="lokaal"></td>
                </tr>
                <tr><th>Aankoopprijs</th><th>Huurprijs</th><th>Opleiding</th></tr>
                <tr>
                    <td><input type="text" value="${sessionScope.machine.aankoopprijs}" name="aankoopprijs"></td>
                    <td><input type="text" value="${sessionScope.machine.huurprijs}" name="huurprijs"></td>
                    <td>${sessionScope.machine.opleiding}</td>
                </tr>
